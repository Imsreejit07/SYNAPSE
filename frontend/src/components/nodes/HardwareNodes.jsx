...
export const TransistorNode = ({ data }) => (
  <div className="px-4 py-2 shadow-md rounded-md bg-slate-800 border-2 border-blue-500 min-w-[100px] text-center">
...
export const MemristorArrayNode = ({ id, data }) => {
  ...
  return (
    <div className="relative p-6 bg-slate-900 border-2 border-slate-600 rounded-lg shadow-2xl font-mono min-w-[200px] group">
      <button 
